...
export class TweetRequests {
	...
	/**
	 * @param id - The id of the tweet whose details are to be fetched using custom endpoint.
	 */
	public static tweetDetail(id: string): AxiosRequestConfig {
		return {
			method: 'get',
			url: 'https://x.com/i/api/graphql/iFEr5AcP121Og4wx9Yqo3w/TweetDetail',
			params: {
				/* eslint-disable @typescript-eslint/naming-convention */
				variables: JSON.stringify({
					focalTweetId: id,
	...
	/**
	 * @param ids - The IDs of the tweets whose details are to be fetched using custom endpoint.
	 */
	public static bulkTweetDetail(ids: string[]): AxiosRequestConfig {
		return {
			method: 'get',
			url: 'https://x.com/i/api/graphql/kPnxYjNX2HCKu8aY96er5w/TweetResultsByRestIds',
			params: {
