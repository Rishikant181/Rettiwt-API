...
export class UserRequests {
	...
	/**
	 * @param id - The id of the user whose articles are to be fetched.
	 * @param count - The number of articles to fetch. Only works as a lower limit when used with a cursor.
